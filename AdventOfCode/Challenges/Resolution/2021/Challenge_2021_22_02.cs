...
{
    public class Challenge_2021_22_02 : IChallengeResolution
    {
        ...
        private void InitializeReactor(List<string> data)
        {
        ...
        private void RebootReactor(List<string> data)
        {
            //for (int i = 0; i < data.Count; i++)
            //{
            ...
            //    for (int x = xPositions[0]; x <= xPositions[1]; x++)
            //    {
            //        for (int y = yPositions[0]; y <= yPositions[1]; y++)
            //        {
            //            for (int z = zPositions[0]; z <= zPositions[1]; z++)
            //            {
            //                _cuboids[(x, y, z)] = isOn;
            //            }
            //        }
        ...
        private List<string> _reBootSteps = new()
        {
