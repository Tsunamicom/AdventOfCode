...
{
    public class Challenge_2022_07_01 : IChallengeResolution
    {
        ...
        public string ResolveChallenge(List<string> data)
        {
            ...
            var directoriesOfSize = _directories.Values.Where(c => c.GetSize() <= sizeLimit);
            var dirSum = directoriesOfSize.Sum(c => c.Size);

            return dirSum.ToString();
        }
    }
}